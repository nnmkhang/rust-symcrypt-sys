...
mod test {
    ...
    fn test_stateless_gcm_encrypt_no_ad() {
        ...
        let (dst, tag) = gcm_encrypt(&p_key, &nonce, None, &pt, 16, cipher).unwrap();
    ...
    fn test_stateless_gcm_decrypt_no_ad() {
        ...
        let dst = gcm_decrypt(&p_key, &nonce, None, &ct, &tag, cipher).unwrap();
    ...
    fn test_stateless_gcm_decrypt_ad() {
        ...
        let dst = gcm_decrypt(&p_key, &nonce, Some(&auth_data), &ct, &tag, cipher).unwrap();
    ...
    fn test_gcm_encrypt() {
        ...
        let mut gcm_state = GcmState::new(&p_key, &nonce, cipher).unwrap();
    ...
    fn test_validate_parameters() {
        ...
        validate_gcm_parameters(cipher, &nonce, &auth_data, &pt, &expected_tag).unwrap();
    }
    ...
    fn test_validate_parameters_fail() {
        ...
        let result = validate_gcm_parameters(cipher, &nonce, &auth_data, &pt, &expected_tag);
